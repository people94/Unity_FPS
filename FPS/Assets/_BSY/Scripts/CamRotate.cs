...
public class CamRotate : MonoBehaviour
{
    ...
    private void Rotate()
    {
        ...
        //유니티엔진에서 제공해쥬ㅜ는 함수를 사용함에 있어서
        //Transloate함수는 그래도 사용하기 큰 불편함이 없는데
        //회전을 담당하는 Rotate함수를 사용하면
        //우리가 제어하기가 힘들다 - 이유 : 짐벌락현상이 발생함. (두개의 축을 동시에 건들면 에러가 나는거)
        //인스펙터창의 로테이션값은 우리가 보기 ㅎ편하게 오일러각도로 표시되지만
        //내부적으로는쿼터니온으로 회전처리가 되고 있다
        ...
        //카메 문제( -90 ~ 90 ) 고정됐다 풀렸다 하ㅡㄴ 문제가 있음
